...
const ClearIceBergIcon = () => {
  return (
    <>
        <span class="text">Clear IceBergs</span>
        <span class='icon'> <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#ffffff">
...
export default ClearIceBergIcon;